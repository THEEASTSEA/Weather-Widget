...
parcelHelpers.export(exports, "requestWeather", ()=>requestWeather);
parcelHelpers.export(exports, "skyState", ()=>skyState);
parcelHelpers.export(exports, "dayMaxMinDegree", ()=>dayMaxMinDegree);
...
async function skyState() {
    const sky = await (0, _axiosDefault.default)({
...
async function dayMaxMinDegree() {
    const dayMaxMin = await (0, _axiosDefault.default)({
    ...
    console.log(dayMaxMinDegree());
    return [
        dayMaxMin.data.response.body.items.item[301].fcstValue,
        dayMaxMin.data.response.body.items.item[120].fcstValue
    ];
}
...
async function printWeatherData() {
    ...
    deg.textContent = Math.round(Number(weatherData[3].obsrValue)) + "\xb0";
    const hum = document.getElementById("hum");
    hum.textContent = weatherData[1].obsrValue + "%";
    const wind = document.getElementById("wind");
    const windText = Number(weatherData[7].obsrValue);
    console.log(windText);
    if (windText === 0) wind.textContent = "바람은 불지 않고,";
    else wind.textContent = `바람은 ${windText}m/s로 불고 있으며,`;
    const rain = document.getElementById("rain");
    const rainText = Number(weatherData[2].obsrValue);
    if (rainText === 0) rain.textContent = "비는 오지 않습니다.";
    else rain.textContent = +`현재 강수량은 ${rainText}mm 입니다.`;
...
var Buffer = require("41dd597f857bc799").Buffer;
"use strict";
/**
...
},{"41dd597f857bc799":"fCgem","../utils.js":"5By4s","../core/AxiosError.js":"3u8Tl","../platform/node/classes/FormData.js":"aFlee","@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}],"fCgem":[function(require,module,exports) {
/*!
...
var base64 = require("e9231e998678371e");
var ieee754 = require("ed78949aa297b994");
...
},{"e9231e998678371e":"eIiSV","ed78949aa297b994":"cO95r"}],"eIiSV":[function(require,module,exports) {
"use strict";
...
},{"@parcel/transformer-js/src/esmodule-helpers.js":"gkKU3"}]},["9ZIyz","adjPd"], "adjPd", "parcelRequire7a4e")
